...
const projectDetails: ProjectDetails = {
    ...
    3: {
        ...
        overview: "Built a full-stack virtual gift card system with end-to-end lifecycle management. The work covered purchase, redemption, validation rules, and backend consistency across orders and transactions. The interesting part was not the UI alone, but the need to make lifecycle rules, redemption behaviour, and transactional integrity work together cleanly.",
        features: [
            "Gift card purchase and issuance flows",
            "Redemption handling with validation and usage rules",
            "Lifecycle tracking across creation, purchase, and redemption stages",
        ...
        contribution: [
            ...
            "Handled edge cases around redemption logic and transactional integrity"
        ],
        outcome: [
            "Delivered a complete virtual gift card capability for the platform",
            "Improved confidence in transaction handling and lifecycle consistency",
